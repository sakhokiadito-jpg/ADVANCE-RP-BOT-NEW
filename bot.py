...
JOBS = {
    "Механик": 22_000,
    "Работник кафе": 22_000,
    "Кассир": 22_000,
    "Автомаляр": 22_500,
    "Заправщик АЗС": 22_500,
    "Мойщик автомобилей": 23_000,
    "Садовник / Фермер": 23_000,
    "Курьер": 23_500,
    "Строитель": 23_500,
    "Инкассатор": 24_000,
    "Таксист (Эконом)": 24_000,
    "Старший механик": 24_500,
    "Водитель автобуса": 25_000,
    "Шеф-повар": 25_000,
    "Таксист (Бизнес-класс)": 25_500,
    "Эвакуаторщик": 26_000,
    "Электрик": 26_500,
    "Дальнобойщик": 27_000,
}
...
GOV_JOBS = {
    "Государственный служащий": 35_000,
    "Секретарь министерства": 38_000,
    "Советник министерства": 42_000,
    "Заместитель министра": 47_000,
    "Бургомистр (Мэр)": 51_000,
    "Министр обороны": 54_000,
    "Министр МВД": 54_000,
    "Министр здравоохранения": 54_000,
    "Вице-канцлер": 58_000,
    "Губернатор": 60_000,
    "Помощник прокурора": 35_000,
    "Прокурор": 38_000,
    "Адвокат": 39_000,
    "Старший прокурор": 42_000,
    "Прокурор района": 47_000,
    "Прокурор города": 51_000,
    "Судья": 56_000,
    "Генеральный прокурор": 60_000,
    "Курсант полиции": 35_000,
    "Полицейский": 38_000,
    "Старший полицейский": 41_000,
    "Младший комиссар полиции": 44_000,
    "Комиссар полиции": 49_000,
    "Старший комиссар полиции": 52_000,
    "Главный комиссар полиции": 55_000,
    "Заместитель шефа полиции": 58_000,
    "Шеф полиции": 60_000,
    "Стажёр МВД": 35_000,
    "Сотрудник МВД": 38_000,
    "Старший сотрудник МВД": 42_000,
    "Следователь МВД": 47_000,
    "Старший следователь МВД": 51_000,
    "Руководитель отдела МВД": 54_000,
    "Заместитель начальника МВД": 58_000,
    "Начальник МВД": 60_000,
    "Рядовой": 33_000,
    "Ефрейтор": 36_000,
    "Младший сержант": 40_000,
    "Лейтенант": 44_000,
    "Капитан": 49_000,
    "Майор": 53_000,
    "Подполковник": 56_000,
    ...
    "Пожарный": 37_000,
    "Фельдшер": 39_000,
    "Врач скорой помощи": 43_000,
    "Терапевт": 48_000,
    "Хирург": 52_000,
    "Старший врач": 55_000,
    "Заместитель главного врача": 58_000,
    "Главный врач": 60_000,
}
...
GOV_JOB_CATEGORIES = [
    ("🏥 Медицина", [
        "Парамедик", "Врач скорой помощи", "Хирург", "Главный врач",
    ]),
    ("⚖️ Юстиция", [
    ...
    ("🏛 Правительство", [
        "Государственный служащий", "Бургомистр (Мэр)", "Министр обороны",
        "Министр МВД", "Министр здравоохранения", "Вице-канцлер", "Губернатор",
    ]),
    ("👮 МВД / Полиция", [
        "Курсант полиции", "Полицейский", "Комиссар полиции", "Старший комиссар полиции",
        "Шеф полиции", "Стажёр МВД", "Сотрудник МВД", "Следователь МВД", "Начальник МВД",
    ]),
    ("🎖 Армия", [
        "Рядовой", "Ефрейтор", "Лейтенант", "Майор", "Подполковник", "Полковник", "Генерал",
    ]),
]
...
@dp.callback_query(F.data.startswith("jobs_gov_") and F.data != "jobs_gov_cats")
